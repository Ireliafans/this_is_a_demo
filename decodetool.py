...
#build the edit and result Text
def edit(root):
...
def md5create(text):
	...
	try:
		...
		return False
	result.insert(1.0, res.hexdigest())
	return True

#def quitbutton(root):
#	quit = tk.Button(root, text='Exit', command=exit, fg='white', bg = 'green')
#	quit.grid()
#	return True
